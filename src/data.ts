export const coreSpecialRules = [
    ...
    {
        name: "Blast",
        description: "Ignores cover and multiplies hits by X, but can't deal more than one hit per model in the target unit.",
    },
    {
        name: "Deadly",
    ...
    {
        name: "Lock",
        description: "n: Ignores all negative modifiers to hit rolls and range.",
    },
    {
        name: "Poison",
